...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Fin_account List</h2>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('account/read/'.$account->code),'Read'); 
				echo ' | '; 
				echo anchor(site_url('account/update/'.$account->code),'Update'); 
				echo ' | '; 
				echo anchor(site_url('account/delete/'.$account->code),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
