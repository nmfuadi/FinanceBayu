...
require_once( APPPATH . 'controllers/base/LoginMarketingBase.php');

class MarketingLogin extends LoginMarketingBase {
    ...
    public function index() {
        $this->VIEW_FILE = "marketing/login/v_login"; // dynamic
