                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="button-box">
                                                        ...
                                                        <a class="btn btn-danger btn-outline btn-xs" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo site_url('Report/Finance/DeletePorcess/' . $val['id'] . '/' . $val['posting_date'].'/PostingImport') ?>">DELETE <i class="fa fa-trash" aria-hidden="true"></i></a>
                                                        <a class="btn btn-success btn-outline btn-xs" href="<?php echo site_url('Report/Finance/editMutasi/' . $val['id'] . '/' . $val['posting_date'].'/PostingImport') ?>">Edit <i class="fa fa-pencil" aria-hidden="true"></i></a>
