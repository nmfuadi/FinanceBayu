                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select  name="rekening" class="form-control">
                                                                ...
                                                                <option value="<?php echo $banks['id']?>" <?php echo $banks['id'] == $data['bank_id'] ? 'selected':''?> ><?php echo $banks['bank_name'].' ('.$banks['bank_norek'].')';?></option>
                                                                <?php }} ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input class="form-control" id='datepicker' type="text" name="trx_date" value="<?php echo $data['trx_date'] ?>" /> </div> </div>
                                                    </div> 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input class="form-control"  type="number" name="amount" value="<?php echo $data['amount'] ?>" /> </div> </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input class="form-control"  type="text" name="remark" value="<?php echo $data['remark'] ?>" /> </div> </div>
                                                    </div>
