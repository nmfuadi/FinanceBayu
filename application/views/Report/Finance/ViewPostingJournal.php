                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $val->currancy.' '.number_format($val->amount,2); ?></td>
                                                <td><?php echo $val->type_mutation; ?></td>
                                                <td><?php echo $val->bank_name.'-'.$val->bank_rek_name. '(' . $val->bank_norek . ')'; ?> </td>
                                                ...
                                                <td>
                                                    <div class="button-box">
                                                        ...
                                                        <a class="btn btn-danger btn-outline btn-xs" onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo site_url('Report/Finance/DeletePorcess/' . $val->mut_id.'/'.$val->posting_date.'/viewAllPostingJournal/'.$start) ?>">DELETE <i class="fa fa-trash" aria-hidden="true"></i></a>
