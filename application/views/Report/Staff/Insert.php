                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $emp['jobs_code']; ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $emp['jobs_tittle']; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $emp['dprt_name']; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $emp['jobs_start']; ?> TO <?php echo $emp['jobs_end']; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
									...
									<input class="form-control" type="hidden" name="jb_id" value="<?php  echo $jb_id; ?>" />									 
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">PROGRESS DETAIL <?php echo form_error('jobs_up_descr') ?></label>
													  <div class="col-md-9">	
														<textarea class="form-control" name="jobs_up_descr" id="editor" placeholder="PROGRESS DETAIL"><?php echo $jobs_up_descr; ?></textarea> 
														</div>
