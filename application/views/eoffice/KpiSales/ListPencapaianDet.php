                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                         ...
                         <!-- Create code here -->
                            ...
                            <h3 class="box-title m-b-0">Detail Pencapaian Sales</h3>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            { 
                                                 ...
                                                 if($settkpi['pencapaianpPerTask']<40){

                                                    $cls = 'progress-bar-danger';
                                                }else if($settkpi['pencapaianpPerTask']>40 and $settkpi['pencapaianpPerTask']<50){
                                                     $cls = 'progress-bar-warning';

                                                }else if($settkpi['pencapaianpPerTask']>=50 and $settkpi['pencapaianpPerTask']<80){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $settkpi['target']; ?></td>
                                            <td><?php echo $settkpi['perbulan']; ?></td>
                                            <td><a href="#" data-toggle="tooltip" data-original-title="<?php echo $settkpi['pencapaianpPerTask']; ?>%">
                                                <div class="progress progress-xs margin-vertical-10 ">
                                                    <div class="progress-bar <?php echo $cls; ?>" style="width: <?php echo $settkpi['pencapaianpPerTask']; ?>%"></div> 
                                                </div>
                                                </a>
                                            </td>
                                            <td><?php echo $settkpi['total_pencapaian']; ?>%</td>
                                            <td><?php echo $settkpi['kpi_weight']; ?>%</td>
                                            <td><?php echo date("M, Y"); ?></td>
                                            <td class="text-nowrap">
                                                
                                                <a href="#" data-toggle="tooltip" data-original-title="Kembali"> <i class="fa fa-backward text-danger"></i> </a>
                                            </td>
                                        </tr>
