                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                 <div class="col-md-12 col-sm-12 col-xs-12">
									<div class="white-box">
										<h3 class="box-title">Diagram Konsumen 2020</h3>
										<ul class="list-inline text-right">
											<?php 
											foreach ($colour as $col){
												
													$war = dechex(crc32($col['cust_stat']));
													$clour = substr($war, 0, 6);
													
													?>
												
											
											<li>
												<h5><i class="fa fa-circle  m-r-5" style="color:#<?php echo $clour; ?>"></i><?php echo $col['cust_stat']; ?></h5> 
											</li>
