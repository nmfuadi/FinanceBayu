                                ...
                                <table id="example23" class="display nowrap table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
											...
											<th style='text-align:center'>PPH 23/26</th>
											<th style='text-align:center'>PPH 15</th>
											<th style='text-align:center'>DJP</th>
											<th style='text-align:center'>DP</th>
											<th style='text-align:center'>Terutang Vendor</th>
											<th style='text-align:center'>Sisa Hutang Vendor</th>
											<th style='text-align:center'>Sisa Tempo</th>
                                    ...
                                    <tbody>
										...
										if (!empty($bill)){
											...
											foreach ($bill as $act){
												if(!empty($act['tax_dpp'])){
													$date1=date_create(date("Y-m-d"));
													$date2=date_create($act['duedate']);
													...
													echo "
													 <tr>
														...
														<td>".$act['emp_name']." <br/><small>".$act['dprt_name']."</small></td>
														<td>".$act['project_name']."</td>
														<td>".$act['vendor_name']."</td>
														<td>".number_format($act['amount'])."</td>
														<td>".$act['description']."</td>
														<td>".number_format($act['tax_dpp'])."</td>
														<td>".number_format($act['tax_ppn'])."</td>
														<td>".number_format($act['tax_pph4_2'])."</td>
														<td>".number_format($act['tax_pph_2126'])."</td>
														<td>".number_format($act['tax_pph_22'])."</td>
														<td>".number_format($act['tax_pph_2326'])."</td>
														<td>".number_format($act['tax_pph_15'])."</td>
														<td>".number_format($act['tax_djp'])."</td>
														<td>".number_format($act['down_payment'])."</td>
														<td>".number_format($act['debt_vendor'])."</td>
														<td>".number_format($act['debt_remaining_vendor'])."</td>
														<td>".$diff->format("%R%a hari")."</td>
														<td>".$act['paid_st']."</td>
														<td>".$act['duedate']."</td>
														<td class='text-nowrap'>
															  <a href='".site_url('eoffice/procurment/Bill/Input Pembayaran/'.$act['id_bill'])."' data-toggle='tooltip' data-original-title='Input Pembayaran'> <i class='fa fa-camera text-inverse m-r-10'></i> </a>
															   <a href='".site_url('eoffice/procurment/Bill/InsertTax/'.$act['id_bill'])."' data-toggle='tooltip' data-original-title='Edit Data Pajak'> <i class='fa fa-plus-circle text-danger'></i> </a>
															</td
