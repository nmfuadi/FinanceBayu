...
class ReCaptcha {
    ...
    public function render() {
        $return = '<div data-theme="light" class="g-recaptcha" data-sitekey="' . $this->_sitekey . '" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
